...
import SortOptionsPart, {
  sortOptions,
} from "../_components/search/SortOptionsPart";
                ...
                <div className="flex items-center gap-4">
                  ...
                  {/* <div className="flex items-center gap-1 bg-white rounded-lg border border-gray-200 p-1">
                    <button
                      ...
                      className={`p-2 rounded-md transition-colors ${currentView === "grid" ? "bg-green-600 text-white" : "text-gray-500 hover:text-gray-700"}`}
                    >
                      <svg
                        width={20}
                        height={16}
                    ...
                    <button
                      ...
                      className={`p-2 rounded-md transition-colors ${currentView === "list" ? "bg-green-600 text-white" : "text-gray-500 hover:text-gray-700"}`}
                    >
                      <svg
                        width={20}
                        height={16}
